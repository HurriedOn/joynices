	...
	$(function(){
	    $(document).scroll(function () { 
	        ...
	        if (scrollTop>navHeight) {
	            $(".localnav-wrappe").addClass("fiex-localnav");
	        } else {
	            $(".localnav-wrappe").removeClass("fiex-localnav");
	        }
	        if($(".nav-wrap").hasClass("open")){
				$(".nav-wrap").removeClass("open")
	    	}
	    });
	    $("#J_mobShow").on("click",function(e){
	    	e.preventDefault();
	    	if($(".nav-wrap").hasClass("open")){
				$(".nav-wrap").removeClass("open")
	    	}else{
	    ...
	    $(".directory-list").on("click",".dire-title",function(e){
			e.preventDefault();
			var dire=$(this).closest(".directory-list");
			if(dire.hasClass("open")){
				dire.removeClass("open").find(".column").slideUp()
			}else{
				dire.addClass("open").find(".column").slideDown()
			}
		});
		var navHear=$(".nav-header");
		var navTogg=navHear.find(".navbar-togger");
...
padding:"inner"+a,content:b,"":"outer"+a},function(c,d){n.fn[d]=function(d,e){var f=arguments.length&&(c||"boolean"!=typeof d),g=c||(d===!0||e===!0?"margin":"border");return Y(this,function(b,c,d){var e;return n.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(e=b.documentElement,Math.max(b.body["scroll"+a],e["scroll"+a],b.body["offset"+a],e["offset"+a],e["client"+a])):void 0===d?n.css(b,c,g):n.style(b,c,d,g)},b,f?d:void 0,f,null)}})}),n.fn.extend({bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)}}),n.fn.size=function(){return this.length},n.fn.andSelf=n.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return n});var nc=a.jQuery,oc=a.$;return n.noConflict=function(b){return a.$===n&&(a.$=oc),b&&a.jQuery===n&&(a.jQuery=nc),n},b||(a.jQuery=a.$=n),n});
	...
	JNC.toast = function(m){
	    var toast = document.createElement('div');
		toast.classList.add('toast-container');
		toast.innerHTML = '<div class="toast-message">' + m + '</div>';
		...
		setTimeout(function() {
			toast && toast.classList.remove("toast-active");
		}, 2000);
		return {
    ...
    JNC.alert=function(message,btnValue) {
		btnValue==undefined?btnValue="确认" : 0;
        var h='<div class='+CLASS_POPUP_INNER+'><div class='+CLASS_POPUP_TEXT+'>'+message+'</div></div><div class='+CLASS_POPUP_BUTTONS+'><span class='+CLASS_POPUP_BUTTON+' '+CLASS_POPUP_BUTTON_BOLD+'>'+btnValue+'</span></div>';
        createPopup(h);
	}
    JNC.confirm = function(message,btnArray, callback) {
		...
		var h='<div class='+CLASS_POPUP_INNER+'><div class='+CLASS_POPUP_TEXT+'>'+message+'</div></div><div class='+CLASS_POPUP_BUTTONS+'><span class='+CLASS_POPUP_BUTTON+'>'+btnArray[0]+'</span><span class='+CLASS_POPUP_BUTTON+' '+CLASS_POPUP_BUTTON_BOLD+'>'+btnArray[1]+'</span></div>';
